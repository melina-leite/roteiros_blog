...
Abaixo descrevo brevemente algumas formas de se testar e verificar graficamente a normalidade multivariada. Vale a pena ver o roteiro de [deteção de valores extremos]() que irá ajudar a entender melhor os dados, já que muitas vezes a presença de _outliers multivariados_ é responsável pela "não-normalidade" dos dados.
