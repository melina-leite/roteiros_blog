...
Neste exemplo, primeiro eu ordeno as companhias aéreas por sua mediana[^1].

[^1]: mas as medianas são bem parecidas então o efeito não fica tão legal quanto poderia.
...
Abaixo alguns exemplos de uso dos lv-plots, com algumas opções para a largura dos plots:
...
```{r lvarea, fig.cap="Um exemplo de lvplot com largura area."}
library(lvplot)
...
```{r lvlinear, fig.cap="Um lvplot com largura do plot linear."}
